...
function updateMemory(){
    ...
    setTimeout(()=>{
        ...
        const imgPath = memories[currentMemory].image;

console.log("Loading image:", imgPath);

memoryImage.src = imgPath;
...
const completeMeScene = document.getElementById("completeMeScene");
function showFinalScene(){

    // Fade away the letter
            ...
            setTimeout(()=>{
                ...
                setTimeout(()=>{
                    ...
                    if(completeMeScene){
                        ...
                        completeMeScene.classList.add("show");
